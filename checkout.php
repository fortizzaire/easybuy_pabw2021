	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><img src="images/easybuylogo3.png" alt="gaada" style="width:200px;"></a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di easybuy</span></h1>
...
<!-- //footer -->
	...
	<div class="footer-botm">
			<div class="container">
				...
				<div class="payment-w3ls" style="width: 100px;">	
					<img src="images/easyone_png.png" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
