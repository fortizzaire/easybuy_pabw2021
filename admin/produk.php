										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td>
														<!-- <button name="ubah" class="btn btn-info col-sm">Ubah</button> -->
														<!-- <button class="btn btn-danger col-sm" style="margin-top: 3px;">Hapus</button> -->
														<a href="hapusfungsi.php?idproduk=<?php echo $p['idproduk']?>"><button class="btn btn-danger col-sm">Hapus</button></a>
													</td>
